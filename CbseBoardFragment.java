...
import com.harsh.jeephysics.CBSEBoard.CbseBiologyPreviousYearActivity;
import com.harsh.jeephysics.CBSEBoard.CbseChemistryPreviousYearActivity;
import com.harsh.jeephysics.CBSEBoard.CbseMathPreviousYearActivity;
import com.harsh.jeephysics.CBSEBoard.CbsePhysicsPreviousYearActivity;
 ...
 */
public class CbseBoardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_cbse_board, container, false);
        ...
        mathPreviousYearBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), CbseMathPreviousYearActivity.class);
                startActivity(intent);
            }
        });
        physicspreviousYearBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), CbsePhysicsPreviousYearActivity.class);
                startActivity(intent);
            }
        });
        chemistryPreviousYearBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), CbseChemistryPreviousYearActivity.class);
                startActivity(intent);
            }
        });
        biologypreviousYearBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), CbseBiologyPreviousYearActivity.class);
                startActivity(intent);
            }
        });
