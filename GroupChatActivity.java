...
import com.harsh.jeephysics.notifications.APIService;
import com.harsh.jeephysics.notifications.Client;
import com.harsh.jeephysics.notifications.Data;
import com.harsh.jeephysics.notifications.Response;
import com.harsh.jeephysics.notifications.Sender;
import com.harsh.jeephysics.notifications.Token;
      ...
      .addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    Data data=new Data(firebaseAuth.getUid(),name+": "+message,"New Message",R.drawable.ic_group);
