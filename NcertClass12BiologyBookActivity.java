...
public class NcertClass12BiologyBookActivity extends AppCompatActivity {
    ...
    private String NCERTClass12Biology1="NCERTClass12Biology1.pdf";
    private String NCERTClass12Biology2="NCERTClass12Biology2.pdf";
    private String NCERTClass12Biology3="NCERTClass12Biology3.pdf";
    private String NCERTClass12Biology4="NCERTClass12Biology4.pdf";
    private String NCERTClass12Biology5="NCERTClass12Biology5.pdf";
    private String NCERTClass12Biology6="NCERTClass12Biology6.pdf";
    private String NCERTClass12Biology7="NCERTClass12Biology7.pdf";
    private String NCERTClass12Biology8="NCERTClass12Biology8.pdf";
    private String NCERTClass12Biology9="NCERTClass12Biology9.pdf";
    private String NCERTClass12Biology10="NCERTClass12Biology10.pdf";
    private String NCERTClass12Biology11="NCERTClass12Biology11.pdf";
    private String NCERTClass12Biology12="NCERTClass12Biology12.pdf";
    private String NCERTClass12Biology13="NCERTClass12Biology13.pdf";
    private String NCERTClass12Biology14="NCERTClass12Biology14.pdf";
    private String NCERTClass12Biology15="NCERTClass12Biology15.pdf";
    private String NCERTClass12Biology16="NCERTClass12Biology16.pdf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ncert_class12_biology_book);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar2);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("NCERT Class 12 Biology Book");
        ...
        checkFileExistence(onlineBtn1, offlineBtn1, downloadBtn1, NCERTClass12Biology1, Url1, progressBar1, txtView1);
        checkFileExistence(onlineBtn2, offlineBtn2, downloadBtn2, NCERTClass12Biology2, Url2, progressBar2, txtView2);
        checkFileExistence(onlineBtn3, offlineBtn3, downloadBtn3, NCERTClass12Biology3, Url3, progressBar3, txtView3);
        checkFileExistence(onlineBtn4, offlineBtn4, downloadBtn4, NCERTClass12Biology4, Url4, progressBar4, txtView4);
        checkFileExistence(onlineBtn5, offlineBtn5, downloadBtn5, NCERTClass12Biology5, Url5, progressBar5, txtView5);
        checkFileExistence(onlineBtn6, offlineBtn6, downloadBtn6, NCERTClass12Biology6, Url6, progressBar6, txtView6);
        checkFileExistence(onlineBtn7, offlineBtn7, downloadBtn7, NCERTClass12Biology7, Url7, progressBar7, txtView7);
        checkFileExistence(onlineBtn8, offlineBtn8, downloadBtn8, NCERTClass12Biology8, Url8, progressBar8, txtView8);
        checkFileExistence(onlineBtn9, offlineBtn9, downloadBtn9, NCERTClass12Biology9, Url9, progressBar9, txtView9);
        checkFileExistence(onlineBtn10, offlineBtn10, downloadBtn10, NCERTClass12Biology10, Url10, progressBar10, txtView10);
        checkFileExistence(onlineBtn11, offlineBtn11, downloadBtn11, NCERTClass12Biology11, Url11, progressBar11, txtView11);
        checkFileExistence(onlineBtn12, offlineBtn12, downloadBtn12, NCERTClass12Biology12, Url12, progressBar12, txtView12);
        checkFileExistence(onlineBtn13, offlineBtn13, downloadBtn13, NCERTClass12Biology13, Url13, progressBar13, txtView13);
        checkFileExistence(onlineBtn14, offlineBtn14, downloadBtn14, NCERTClass12Biology14, Url14, progressBar14, txtView14);
        checkFileExistence(onlineBtn15, offlineBtn15, downloadBtn15, NCERTClass12Biology15, Url15, progressBar15, txtView15);
        checkFileExistence(onlineBtn16, offlineBtn16, downloadBtn16, NCERTClass12Biology16, Url16, progressBar16, txtView16);
        ...
        downloadBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology1, Url1, onlineBtn1, offlineBtn1, downloadBtn1, txtView1, progressBar1);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology2, Url2, onlineBtn2, offlineBtn2, downloadBtn2, txtView2, progressBar2);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology3, Url3, onlineBtn3, offlineBtn3, downloadBtn3, txtView3, progressBar3);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology4, Url4, onlineBtn4, offlineBtn4, downloadBtn4, txtView4, progressBar4);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology5, Url5, onlineBtn5, offlineBtn5, downloadBtn5, txtView5, progressBar5);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology6, Url6, onlineBtn6, offlineBtn6, downloadBtn6, txtView6, progressBar6);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology7, Url7, onlineBtn7, offlineBtn7, downloadBtn7, txtView7, progressBar7);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology8, Url8, onlineBtn8, offlineBtn8, downloadBtn8, txtView8, progressBar8);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology9, Url9, onlineBtn9, offlineBtn9, downloadBtn9, txtView9, progressBar9);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology10, Url10, onlineBtn10, offlineBtn10, downloadBtn10, txtView10, progressBar10);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology11, Url11, onlineBtn11, offlineBtn11, downloadBtn11, txtView11, progressBar11);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology12, Url12, onlineBtn12, offlineBtn12, downloadBtn12, txtView12, progressBar12);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology13, Url13, onlineBtn13, offlineBtn13, downloadBtn13, txtView13, progressBar13);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology14, Url14, onlineBtn14, offlineBtn14, downloadBtn14, txtView14, progressBar14);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology15, Url15, onlineBtn15, offlineBtn15, downloadBtn15, txtView15, progressBar15);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass12Biology16, Url16, onlineBtn16, offlineBtn16, downloadBtn16, txtView16, progressBar16);
                }else{
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        onlineBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    Intent intent = new Intent(NcertClass12BiologyBookActivity.this, WebActivity.class);
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    offline.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(NcertClass12BiologyBookActivity.this, PdfActivity.class);
                    ...
                    Toast.makeText(NcertClass12BiologyBookActivity.this, "Unable to download this pdf", Toast.LENGTH_SHORT).show();
                    File file = getFileStreamPath(fileName);
                    file.delete();
