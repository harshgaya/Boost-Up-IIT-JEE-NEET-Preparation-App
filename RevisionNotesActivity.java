...
public class RevisionNotesActivity extends AppCompatActivity {
    ...
    private String Url2="https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FIITs%2FRevision%20Notes%2Fchemistry%20formulas.pdf?alt=media&token=72279adb-b527-4a9d-8660-fb80244f21c2";
    private String Url3="https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FIITs%2FRevision%20Notes%2FMathematics-Formula-Booklet.pdf?alt=media&token=635fcbf3-075a-4bb1-b0d4-559fb1cfb010";


    private String RevisionNotes="RevisionNotes.pdf";
    private String RevisionNotes2="RevisionNotes2.pdf";
    private String RevisionNotes3="RevisionNotes3.pdf";

    private TextView txtView1,txtView2,txtView3;
    private ProgressBar progressBar1,progressBar2,progressBar3;
    private Button downloadBtn1,downloadBtn2,downloadBtn3;
    private Button onlineBtn1,onlineBtn2,onlineBtn3;
    private Button offlineBtn1,offlineBtn2,offlineBtn3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Revision Notes ");
        ...
        checkFileExistence(onlineBtn1, offlineBtn1, downloadBtn1, RevisionNotes, Url1, progressBar1, txtView1);
        checkFileExistence(onlineBtn2, offlineBtn2, downloadBtn2, RevisionNotes2, Url2, progressBar2, txtView2);
        checkFileExistence(onlineBtn3, offlineBtn2, downloadBtn2, RevisionNotes3, Url3, progressBar3, txtView3);
        ...
        downloadBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(RevisionNotes, Url1, onlineBtn1, offlineBtn1, downloadBtn1, txtView1, progressBar1);
                }else{
                    Toast.makeText(RevisionNotesActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(RevisionNotes2, Url2, onlineBtn2, offlineBtn2, downloadBtn2, txtView2, progressBar2);
                }else{
                    Toast.makeText(RevisionNotesActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(RevisionNotes3, Url3, onlineBtn3, offlineBtn3, downloadBtn3, txtView3, progressBar3);
                }else{
                    Toast.makeText(RevisionNotesActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        onlineBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    Intent intent = new Intent(RevisionNotesActivity.this, WebActivity.class);
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    offline.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(RevisionNotesActivity.this, PdfActivity.class);
                    ...
                    Toast.makeText(RevisionNotesActivity.this, "Unable to download this pdf", Toast.LENGTH_SHORT).show();
                    File file = getFileStreamPath(fileName);
                    file.delete();
