...
public class BsebChemistryPreviousYearActivity extends AppCompatActivity {
    ...
    private String Url2= "https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FBihar%20Board%2Fbihar-board-class-12th-chemistry-question-paper-2019.pdf?alt=media&token=c527d85a-f2e4-4de2-add0-8918d5a60e86";
    private String Url3= "https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FBihar%20Board%2FBihar-Board-Class-12-Chemistry-Question-Paper-2018.pdf?alt=media&token=acd0b2cc-8506-49f0-8160-54bcdb7d3f03";


    private String BSEBChemistryPreviousYear1="BSEBChemistryPreviousYear1.pdf";
    private String BSEBChemistryPreviousYear2="BSEBChemistryPreviousYear2.pdf";
    private String BSEBChemistryPreviousYear3="BSEBChemistryPreviousYear3.pdf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bseb_chemistry_previous_year);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar2);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("BSEB Chemistry Previous Year");
        ...
        checkFileExistence(onlineBtn1, offlineBtn1, downloadBtn1, BSEBChemistryPreviousYear1, Url1, progressBar1, txtView1);
        checkFileExistence(onlineBtn2, offlineBtn2, downloadBtn2, BSEBChemistryPreviousYear2, Url2, progressBar2, txtView2);
        checkFileExistence(onlineBtn3, offlineBtn3, downloadBtn3, BSEBChemistryPreviousYear3, Url3, progressBar3, txtView3);
        ...
        downloadBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(BSEBChemistryPreviousYear1, Url1, onlineBtn1, offlineBtn1, downloadBtn1, txtView1, progressBar1);
                }else{
                    Toast.makeText(BsebChemistryPreviousYearActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(BSEBChemistryPreviousYear2, Url2, onlineBtn2, offlineBtn2, downloadBtn2, txtView2, progressBar2);
                }else{
                    Toast.makeText(BsebChemistryPreviousYearActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(BSEBChemistryPreviousYear3, Url3, onlineBtn3, offlineBtn3, downloadBtn3, txtView3, progressBar3);
                }else{
                    Toast.makeText(BsebChemistryPreviousYearActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        onlineBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    Intent intent = new Intent(BsebChemistryPreviousYearActivity.this, WebActivity.class);
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    offline.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(BsebChemistryPreviousYearActivity.this, PdfActivity.class);
                    ...
                    Toast.makeText(BsebChemistryPreviousYearActivity.this, "Unable to download this pdf", Toast.LENGTH_SHORT).show();
                    File file = getFileStreamPath(fileName);
                    file.delete();
