...
public class BSEBMathPreviousYearActivity extends AppCompatActivity {
    ...
    private String Url2= "https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FBihar%20Board%2Fbihar-board-class-12th-maths-question-paper-2019.pdf?alt=media&token=b44e8eea-62af-42e8-98e7-4fb8df953e98";
    private String Url3= "https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FBihar%20Board%2FBihar-Board-Class-12-Maths-Question-Paper-2018.pdf?alt=media&token=f40c9ce6-a66b-44c8-8438-3f1680b6c802";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b_s_e_b_math_previous_year);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar2);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("BSEB Math Previous Year ");
        ...
        downloadBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    Toast.makeText(BSEBMathPreviousYearActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        onlineBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    Intent intent = new Intent(BSEBMathPreviousYearActivity.this, WebActivity.class);
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    offline.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(BSEBMathPreviousYearActivity.this, PdfActivity.class);
                    ...
                    Toast.makeText(BSEBMathPreviousYearActivity.this, "Unable to download this pdf", Toast.LENGTH_SHORT).show();
                    File file = getFileStreamPath(fileName);
                    file.delete();
