...
public class NcertClass11BiologyBookActivity extends AppCompatActivity {
    ...
    private String NCERTClass11Biology1="NCERTClass11Biology1.pdf";
    private String NCERTClass11Biology2="NCERTClass11Biology2.pdf";
    private String NCERTClass11Biology3="NCERTClass11Biology3.pdf";
    private String NCERTClass11Biology4="NCERTClass11Biology4.pdf";
    private String NCERTClass11Biology5="NCERTClass11Biology5.pdf";
    private String NCERTClass11Biology6="NCERTClass11Biology6.pdf";
    private String NCERTClass11Biology7="NCERTClass11Biology7.pdf";
    private String NCERTClass11Biology8="NCERTClass11Biology8.pdf";
    private String NCERTClass11Biology9="NCERTClass11Biology9.pdf";
    private String NCERTClass11Biology10="NCERTClass11Biology10.pdf";
    private String NCERTClass11Biology11="NCERTClass11Biology11.pdf";
    private String NCERTClass11Biology12="NCERTClass11Biology12.pdf";
    private String NCERTClass11Biology13="NCERTClass11Biology13.pdf";
    private String NCERTClass11Biology14="NCERTClass11Biology14.pdf";
    private String NCERTClass11Biology15="NCERTClass11Biology15.pdf";
    private String NCERTClass11Biology16="NCERTClass11Biology16.pdf";
    private String NCERTClass11Biology17="NCERTClass11Biology17.pdf";
    private String NCERTClass11Biology18="NCERTClass11Biology18.pdf";
    private String NCERTClass11Biology19="NCERTClass11Biology19.pdf";
    private String NCERTClass11Biology20="NCERTClass11Biology20.pdf";
    private String NCERTClass11Biology21="NCERTClass11Biology21.pdf";
    private String NCERTClass11Biology22="NCERTClass11Biology22.pdf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ncert_class11_biology_book);


        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar2);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("NCERT Biology Class 11");
        ...
        checkFileExistence(onlineBtn1, offlineBtn1, downloadBtn1, NCERTClass11Biology1, Url1, progressBar1, txtView1);
        checkFileExistence(onlineBtn2, offlineBtn2, downloadBtn2, NCERTClass11Biology2, Url2, progressBar2, txtView2);
        checkFileExistence(onlineBtn3, offlineBtn3, downloadBtn3, NCERTClass11Biology3, Url3, progressBar3, txtView3);
        checkFileExistence(onlineBtn4, offlineBtn4, downloadBtn4, NCERTClass11Biology4, Url4, progressBar4, txtView4);
        checkFileExistence(onlineBtn5, offlineBtn5, downloadBtn5, NCERTClass11Biology5, Url5, progressBar5, txtView5);
        checkFileExistence(onlineBtn6, offlineBtn6, downloadBtn6, NCERTClass11Biology6, Url6, progressBar6, txtView6);
        checkFileExistence(onlineBtn7, offlineBtn7, downloadBtn7, NCERTClass11Biology7, Url7, progressBar7, txtView7);
        checkFileExistence(onlineBtn8, offlineBtn8, downloadBtn8, NCERTClass11Biology8, Url8, progressBar8, txtView8);
        checkFileExistence(onlineBtn9, offlineBtn9, downloadBtn9, NCERTClass11Biology9, Url9, progressBar9, txtView9);
        checkFileExistence(onlineBtn10, offlineBtn10, downloadBtn10, NCERTClass11Biology10, Url10, progressBar10, txtView10);
        checkFileExistence(onlineBtn11, offlineBtn11, downloadBtn11, NCERTClass11Biology11, Url11, progressBar11, txtView11);
        checkFileExistence(onlineBtn12, offlineBtn12, downloadBtn12, NCERTClass11Biology12, Url12, progressBar12, txtView12);
        checkFileExistence(onlineBtn13, offlineBtn13, downloadBtn13, NCERTClass11Biology13, Url13, progressBar13, txtView13);
        checkFileExistence(onlineBtn14, offlineBtn14, downloadBtn14, NCERTClass11Biology14, Url14, progressBar14, txtView14);
        checkFileExistence(onlineBtn15, offlineBtn15, downloadBtn15, NCERTClass11Biology15, Url15, progressBar15, txtView15);
        checkFileExistence(onlineBtn16, offlineBtn16, downloadBtn16, NCERTClass11Biology16, Url16, progressBar16, txtView16);
        checkFileExistence(onlineBtn17, offlineBtn17, downloadBtn17, NCERTClass11Biology17, Url17, progressBar17, txtView17);
        checkFileExistence(onlineBtn18, offlineBtn18, downloadBtn18, NCERTClass11Biology18, Url18, progressBar18, txtView18);
        checkFileExistence(onlineBtn19, offlineBtn19, downloadBtn19, NCERTClass11Biology19, Url19, progressBar19, txtView19);
        checkFileExistence(onlineBtn20, offlineBtn20, downloadBtn20, NCERTClass11Biology20, Url20, progressBar20, txtView20);
        checkFileExistence(onlineBtn21, offlineBtn21, downloadBtn21, NCERTClass11Biology21, Url21, progressBar21, txtView21);
        checkFileExistence(onlineBtn22, offlineBtn22, downloadBtn22, NCERTClass11Biology22, Url22, progressBar22, txtView22);
        ...
        downloadBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology1, Url1, onlineBtn1, offlineBtn1, downloadBtn1, txtView1, progressBar1);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology2, Url2, onlineBtn2, offlineBtn2, downloadBtn2, txtView2, progressBar2);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology3, Url3, onlineBtn3, offlineBtn3, downloadBtn3, txtView3, progressBar3);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology4, Url4, onlineBtn4, offlineBtn4, downloadBtn4, txtView4, progressBar4);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology5, Url5, onlineBtn5, offlineBtn5, downloadBtn5, txtView5, progressBar5);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology6, Url6, onlineBtn6, offlineBtn6, downloadBtn6, txtView6, progressBar6);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology7, Url7, onlineBtn7, offlineBtn7, downloadBtn7, txtView7, progressBar7);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology8, Url8, onlineBtn8, offlineBtn8, downloadBtn8, txtView8, progressBar8);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology9, Url9, onlineBtn9, offlineBtn9, downloadBtn9, txtView9, progressBar9);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology10, Url10, onlineBtn10, offlineBtn10, downloadBtn10, txtView10, progressBar10);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology11, Url11, onlineBtn11, offlineBtn11, downloadBtn11, txtView11, progressBar11);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology12, Url12, onlineBtn12, offlineBtn12, downloadBtn12, txtView12, progressBar12);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology13, Url13, onlineBtn13, offlineBtn13, downloadBtn13, txtView13, progressBar13);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology14, Url14, onlineBtn14, offlineBtn14, downloadBtn14, txtView14, progressBar14);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology15, Url15, onlineBtn15, offlineBtn15, downloadBtn15, txtView15, progressBar15);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology16, Url16, onlineBtn16, offlineBtn16, downloadBtn16, txtView16, progressBar16);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology17, Url17, onlineBtn17, offlineBtn17, downloadBtn17, txtView17, progressBar17);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology18, Url18, onlineBtn18, offlineBtn18, downloadBtn18, txtView18, progressBar18);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology19, Url19, onlineBtn19, offlineBtn19, downloadBtn19, txtView19, progressBar19);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn20.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology20, Url20, onlineBtn20, offlineBtn20, downloadBtn20, txtView20, progressBar20);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn21.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology21, Url21, onlineBtn21, offlineBtn21, downloadBtn21, txtView21, progressBar21);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(NCERTClass11Biology22, Url22, onlineBtn22, offlineBtn22, downloadBtn22, txtView22, progressBar22);
                }else{
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        onlineBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    Intent intent = new Intent(NcertClass11BiologyBookActivity.this, WebActivity.class);
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    offline.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(NcertClass11BiologyBookActivity.this, PdfActivity.class);
                    ...
                    Toast.makeText(NcertClass11BiologyBookActivity.this, "Unable to download this pdf", Toast.LENGTH_SHORT).show();
                    File file = getFileStreamPath(fileName);
                    file.delete();
