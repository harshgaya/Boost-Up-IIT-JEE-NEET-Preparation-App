...
public class BsebPhysicsPreviousYearActivity extends AppCompatActivity {
    ...
    private String Url2= "https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FBihar%20Board%2Fbihar-board-class-12th-physics-question-paper-2019.pdf?alt=media&token=8f456e9e-ecf6-40bc-b91e-86841bdd8803";
    private String Url3= "https://firebasestorage.googleapis.com/v0/b/chatapp-3ff1d.appspot.com/o/PDFs%2FBihar%20Board%2FBihar-Board-Class-12-Physics-Question-Paper-2018.pdf?alt=media&token=7fb2800d-ae1f-4094-be0a-852d948ead44";


    private String BSEBPhysicsPreviousYear1="BSEBPhysicsPreviousYear1.pdf";
    private String BSEBPhysicsPreviousYear2="BSEBPhysicsPreviousYear2.pdf";
    private String BSEBPhysicsPreviousYear3="BSEBPhysicsPreviousYear3.pdf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bseb_physics_previous_year);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar2);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("BSEB Physics Previous Year");
        ...
        checkFileExistence(onlineBtn1, offlineBtn1, downloadBtn1, BSEBPhysicsPreviousYear1, Url1, progressBar1, txtView1);
        checkFileExistence(onlineBtn2, offlineBtn2, downloadBtn2, BSEBPhysicsPreviousYear2, Url2, progressBar2, txtView2);
        checkFileExistence(onlineBtn3, offlineBtn3, downloadBtn3, BSEBPhysicsPreviousYear3, Url3, progressBar3, txtView3);
        ...
        downloadBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(BSEBPhysicsPreviousYear1, Url1, onlineBtn1, offlineBtn1, downloadBtn1, txtView1, progressBar1);
                }else{
                    Toast.makeText(BsebPhysicsPreviousYearActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(BSEBPhysicsPreviousYear2, Url2, onlineBtn2, offlineBtn2, downloadBtn2, txtView2, progressBar2);
                }else{
                    Toast.makeText(BsebPhysicsPreviousYearActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        downloadBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    ...
                    downloadPdf(BSEBPhysicsPreviousYear3, Url3, onlineBtn3, offlineBtn3, downloadBtn3, txtView3, progressBar3);
                }else{
                    Toast.makeText(BsebPhysicsPreviousYearActivity.this, "Connect to internet !", Toast.LENGTH_SHORT).show();
                }
        ...
        onlineBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkConnected()) {
                    Intent intent = new Intent(BsebPhysicsPreviousYearActivity.this, WebActivity.class);
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    offline.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(BsebPhysicsPreviousYearActivity.this, PdfActivity.class);
                    ...
                    Toast.makeText(BsebPhysicsPreviousYearActivity.this, "Unable to download this pdf", Toast.LENGTH_SHORT).show();
                    File file = getFileStreamPath(fileName);
                    file.delete();
