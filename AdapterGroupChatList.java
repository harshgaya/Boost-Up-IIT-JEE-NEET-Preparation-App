...
public class AdapterGroupChatList extends RecyclerView.Adapter<AdapterGroupChatList.HolderGroupChatList>{
    ...
    public void onBindViewHolder(@NonNull HolderGroupChatList holder, int position) {
        ...
        try{
            Picasso.get().load(groupIcon).placeholder(R.drawable.groupplaceholdertwo).into(holder.groupIconIv);
        }
       catch (Exception e){
            holder.groupIconIv.setImageResource(R.drawable.groupplaceholdertwo);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds:dataSnapshot.getChildren()){
                            ...
                            String dateTime= DateFormat.format("MMMM d, yyyy hh:mm:ss aa",cal).toString();
