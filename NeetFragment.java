...
import com.harsh.jeephysics.IIT.PhysicsStudyMaterialActivity;
...
import com.harsh.jeephysics.NEET.NeetPreviousYearActivity;
...
public class NeetFragment extends Fragment {
    ...
    Button NCERTClass11Physics,NCERTClass11PhysicsSolution,NCERTClasss12PhysicsBookBtn,NCERTClasss12PhysicsBookSolutionBtn,NCERTClass11Chemistry,NCERTClass11ChemistrySolution
            ,NCERTClass11BiologyBookBtn,NCERTClass11BiologySolutionBtn,NCERTClass12BiologyBtn,NCERTClass12BiologySolutionBtn,physicsStudyMaterialBtn,ChemistryStudyMaterialBtn,
            PreviousYearNeetBtn,NCERTClass12ChemistrySolution,NCERTClass12Chemistry;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_neet, container, false);
        ...
        physicsStudyMaterialBtn=view.findViewById(R.id.physicsStudyMaterialBtn);
        ChemistryStudyMaterialBtn=view.findViewById(R.id.ChemistryStudyMaterialBtn);

        PreviousYearNeetBtn=view.findViewById(R.id.PreviousYearNeetBtn);
        ...
        physicsStudyMaterialBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), PhysicsStudyMaterialActivity.class);
                startActivity(intent);
            }
        });
        ...
        PreviousYearNeetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), NeetPreviousYearActivity.class);
                startActivity(intent);
            }
        });
